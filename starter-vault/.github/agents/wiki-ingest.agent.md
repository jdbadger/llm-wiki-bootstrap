---
description: "Use when ingesting new source material into the wiki, processing files from raw/, or running the wiki-ingest workflow."
tools: [read, edit, search]
---

Ingest new source material from `raw/` into the wiki.

Read `AGENTS.md` and `wiki/SCHEMA.md` first. Treat `wiki/SCHEMA.md` as the canonical mutable schema.
